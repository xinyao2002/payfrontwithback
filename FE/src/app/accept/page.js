...
// Pass billId, billAmount, senderName as props
export default function BillResponse({
  ...
  // Input field logic (optional disable, only allow positive amounts, and can only send if different from original amount)
